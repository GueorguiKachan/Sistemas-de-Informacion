...
<div class="container-fluid">
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="9" style="text-align:center">Resultados de busqueda de jugador - ${jugador.get(0).nombre}</th></tr>
			<tr>
			<th>Nombre<img src="" alt="" style="float:right;"></img></th>
				<th>Edad<img src="" alt="" style="float:right;"></th>
	...
	List<JugadorVO> jugadores = (List<JugadorVO>)request.getAttribute("jugador");
	for(JugadorVO jugador : jugadores)
	{
		EquipoVO equipo = dao2.getTeam(jugador.getEquipo());
		%>
	    <tr>
	      <td><a href='busquedaJugador?id=<%=jugador.getId()%>'><%=jugador.getNombre()%></a></td>
	      <td><%=jugador.getEdad()%></td>
	      <td><a href='jugadoresEquipo?equipo=<%=jugador.getEquipo()%>'><%=jugador.getEquipo()%></a></td>
	     ...
	     <% if(session.getAttribute("user") != null){%>      
	       <td>
                <div class="modal-box" style="margin:auto">
                <button type="button" class="fas fa-edit" data-toggle="modal" data-target="#editar-jugador"></button>
                </div>
                </td>
                
                <div id="editar-jugador"  class="modal fade" tabindex="-1" role="dialog">
	            <div class="modal-dialog" role="document" >
	            <div class="modal-content clearfix">
	            <div class="modal-body">
	            <button data-dismiss="modal" class="close">&times;</button>
...
<!--!!!!!-->	<input type="hidden" id="solicitudJugadorNombre" name="solicitudJugadorNombre" value="<%=jugador.getId()%>" readonly></input>
	            <input type="text" value="<%=jugador.getNombre()%>" readonly></input>
