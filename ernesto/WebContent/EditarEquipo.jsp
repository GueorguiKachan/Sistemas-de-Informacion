...
<%@ page import="es.unizar.sisinf.grp1.model.GrupoFacade" %>
<%@ page import="es.unizar.sisinf.grp1.model.GrupoVO" %>
...
<div class="container-fluid">
		<%
	EquipoVO evo = (EquipoVO)request.getAttribute("equipo");
	SolicitudVO svo = (SolicitudVO)request.getAttribute("solicitud"); 
	%>
	
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="3" style="text-align:center">Campo a cambiar: <%=svo.getCampo()%></th>
			<th colspan="4" style="text-align:center">Nuevo Valor: <%=svo.getValor()%></th>
			</tr>
			<tr>
			<th>Equipo<img src="" alt="" style="float:right;"></img></th>
				<th>Grupo<img src="" alt="" style="float:right;"></img></th>
				...
				<th>Precio<img src="" alt="" style="float:right;"></th>
				
			</tr>
			<tbody>
	
    <tr>
    <form action="GuardarEditarEquipo" method="get">
    <input type="hidden" name="idsolicitud" value="<%=svo.getId()%>"></input>
      <td><input type="text" name="equipo" value="<%=evo.getTeamName()%>" style="width: 150px;" readonly></input></td>
      <td><input type="text" name="grupo" value="<%=evo.getGrupo()%>" style="width: 150px;" ></input></td>
      <td><input type="text" name="numjugadores" value="<%=evo.getNumJugadores() %>"  style="width: 150px;" readonly></input></td>
      <td><input type="text" name="estadio" value="<%=evo.getStadium()%>" style="width: 150px;" ></input></td>
      <td><input type="text" name="capacidad" value="<%=evo.getCapacidad() %>" style="width: 150px;" ></input></td>
      <td><input type="text" name="cesped" value="<%=evo.getCesped()%>" style="width: 150px;" ></input></td>
      <td><input type="text" name="precio" value="<%=evo.getPrecio()%>" style="width: 150px;" ></input></td>   
       <td><button type="submit" class="fas fa-edit" ></button></td>
       </form>
      </tr>
