...
<div class="container-fluid">
		<%
	JugadorVO jvo = (JugadorVO)request.getAttribute("jugador");
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="4" style="text-align:center">Campo a cambiar: <%=svo.getCampo()%></th>
			...
			<th>Nombre<img src="" alt="" style="float:right;"></img></th>
				...
				<th>Nacido<img src="" alt="" style="float:right;"></th>
    ...
    <tr>
    <form action="GuardarEditarJugador" method="get">
    <input type="hidden" name="idjugador" value="<%=jvo.getId()%>"/>
    <input type="hidden" name="idsolicitud" value="<%=svo.getId()%>"></input>
      <td><input type="text" name="nombre" value="<%=jvo.getNombre()%>" style="width: 120px;" readonly></input></td>
      <td><input type="text" name="equipo" value="<%=jvo.getEquipo()%>" style="width: 120px;" ></input></td>
      <td><input type="text" name="nacido" value="<%=jvo.getNacido() %>"  style="width: 120px;" ></input></td>
      <td><input type="text" name="pjugados" value="<%=jvo.getP_jugados()%>" style="width: 120px;" ></input></td>
      <td><input type="text" name="ptitular" value="<%=jvo.getP_titular() %>" style="width: 120px;" ></input></td>
      <td><input type="text" name="amarillas" value="<%=jvo.getAmarillas()%>" style="width: 120px;" ></input></td>
      <td><input type="text" name="rojas" value="<%=jvo.getRojas()%>" style="width: 120px;" ></input></td>   
      <td><input type="text" name="goles" value="<%=jvo.getGoles()%>" style="width: 120px;" ></input></td>   
