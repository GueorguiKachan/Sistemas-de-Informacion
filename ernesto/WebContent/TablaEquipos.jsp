...
<div class="cabecera">
  <div class="row">
        ...
        <button type="submit" class="btn btn-primary " style="background-color:#669999; color:white; margin:auto;">Solicitudes</button>
        </form>
        </div>
        <% }%>
        <div style="margin:auto">
 ...
 <div id="buscadores">
	...
	<form name="buscar" action="buscaEquipo"  method="get" style="margin:auto;display:flex;max-width:210px">
	  		<input type="text" name="nombre"  placeholder="Introduzca un Equipo" size="17">
	 		<button type="submit"><i class="fa fa-angle-double-right"></i></button>
	</form>
	</div>
 </div>
...
<div class="container-fluid">
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="7" style="text-align:center">Equipos de ${equiposGrupo.get(0).grupo}</th></tr>
			<tr>
				<th>Equipo<img src="" alt="" style="float:right;"></img></th>
                <th>Grupo<img src="" alt="" style="float:right;"></th>
                <th>Nº Jugadores<img src="" alt="" style="float:right;"></th>
                <th>Estadio<img src="" alt="" style="float:right;"></th>
                <th>Capacidad<img src="" alt="" style="float:right;"></th>
                <th>Cesped<img src="" alt="" style="float:right;"></th>
                <th>Pr.Entradas<img src="" alt="" style="float:right;"></th>
				
			</tr>
			<tbody>
	<%
			
	List<EquipoVO> equiposGrupo = (List<EquipoVO>)request.getAttribute("equiposGrupo");
	for(EquipoVO equipo :equiposGrupo)
	{
	%>
    <tr>
      <td><a href='jugadoresEquipo?equipo=<%=equipo.getTeamName()%>'><%=equipo.getTeamName()%></a></td>
      <td><a href='equiposGrupo?grupo=<%=equipo.getGrupo()%>'><%=equipo.getGrupo()%></a></td>
      <td><%=equipo.getNumJugadores()%></td>
      <td><%=equipo.getStadium()%></td>
      <td><%=equipo.getCapacidad()%></td>
      <td><%=equipo.getCesped()%></td>
      <td><%=equipo.getPrecio()%></td>
    <% if(session.getAttribute("user") != null){%>      
	       <td>
                <div class="modal-box" style="margin:auto">
                <button type="button" class="fas fa-edit" data-toggle="modal" data-target="#editar-equipo"></button>
                </div>
                </td>
                
                <div id="editar-equipo"  class="modal fade" tabindex="-1" role="dialog">
	            <div class="modal-dialog" role="document" >
	            <div class="modal-content clearfix">
	            <div class="modal-body">
	            <button data-dismiss="modal" class="close">&times;</button>
	            <div class="row">
	            <div class="col-12" style="text-align:left"> <!--!!!!! Alinear a la izda-->
	            <form name="solicitudEquipo" action="crearSolicitudEquipo" method="get">
<!--!!!!!-->	<div class="form-group">
	            <label for="solicitudEquipoNombre">Nombre:</label>
<!--!!!!!-->	<input type="text" id="solicitudEquipoNombre" name="solicitudEquipoNombre" value="<%=equipo.getTeamName()%>" readonly></input>
<!--!!!!!-->	</div> <!--!!!!! Se mete cada pareja label-input en estos div-->
	            <div class="form-group">
	            <label for="solicitudEquipoCampo">Campo a modificar:</label>
	            <select id="solicitudEquipoCampo" name="solicitudEquipoCampo">
				<option value="precioent">Precio entradas</option>
				<option value="estadio">Estadio</option>
				<option value="capacidad">Capacidad</option>
				<option value="tipocesped">Tipo cesped</option>
...
<!--!!!!!-->  <div class="form-group" style="text-align:center"> <!--!!!!! Boton centrado-->
	            <input type="submit" class="btn btn-primary btn-sm" style="background-color:#117A65; color:white; margin:auto;" value="Enviar"></input>
	            </div>
	            </form>
	            </div>
	            </div>
