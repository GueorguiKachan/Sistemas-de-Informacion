...
<div class="container-fluid">
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="2" style="text-align:center">Grupos de Aragon</th></tr>
			<tr>
				<th>Grupo<img src="" alt="" style="float:right;"></img></th>
				<th>Nº Equipos <img src="" alt="" style="float:right;"></th>
				
			</tr>
			<tbody>
	<%
	GrupoFacade dao = new GrupoFacade();		
	List<GrupoVO> grupos = new ArrayList<>();
	grupos = dao.getTodosGrupos();
	for(GrupoVO grupo : grupos)
	{
	%>
    <tr>
      <td><a href='equiposGrupo?grupo=<%=grupo.getNombre()%>'><%=grupo.getNombre()%></a></td>
      <td><%=grupo.getN_equipos()%></td>
    </tr>
        <%
