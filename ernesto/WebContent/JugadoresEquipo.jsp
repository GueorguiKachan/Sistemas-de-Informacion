...
<div class="container-fluid">
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="7" style="text-align:center">Jugadores de ${jugadoresEquipo.get(0).equipo}</th></tr>
			<tr>
				<th>Nombre<img src="" alt="" style="float:right;"></img></th>
				<th>Nacido(Edad)<img src="" alt="" style="float:right;"></th>
			...
			<tbody>
	<%
	List<JugadorVO> jugadoresEquipo = (List<JugadorVO>)request.getAttribute("jugadoresEquipo");
	for(JugadorVO jugador :jugadoresEquipo)
	{
	%>
    <tr>
      <td><a href='busquedaJugador?id=<%=jugador.getId()%>'><%=jugador.getNombre()%></a></td>
      <td><%=jugador.getNacido()%>(<%=jugador.getEdad()%>)</td>
