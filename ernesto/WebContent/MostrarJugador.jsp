...
<div class="container-fluid">
		<%
	JugadorVO jugador = (JugadorVO)request.getAttribute("jugador");
	%>
	
	<div class="table-responsive">
		<table class="table table-striped table-hover mx-auto w-auto">
			<tr>
			<th colspan="3" style="text-align:center">Jugador: <%=jugador.getNombre()%></th>
			<th colspan="4" style="text-align:center">Equipo: <%=jugador.getEquipo()%></th>
			</tr>
			<tr>
