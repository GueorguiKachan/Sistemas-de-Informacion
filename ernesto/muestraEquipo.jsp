...
<div class="cabecera">
 ...
 <div id="buscadores">
    <div class="row">
    <form name="buscar" action="muestraEquipo" method="get" style="margin:auto;display:flex;max-width:210px">
            <input type="text" name="grupo"  placeholder="Introduzca un grupo" size="17">
            <button type="submit"><i class="fa fa-angle-double-right"></i></button>
    </form>
    <form name="buscar" action="mues" method="get" style="margin:auto;display:flex;max-width:210px">
